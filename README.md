...
These launchers create a dedicated virtual environment, install dependencies from `requirements.txt`, and then open the Streamlit app in your browser.

> **Prerequisite:** Install Python 3.9 or newer first. The launchers will check for it and tell you where to download it if it is missing.

### Windows
1. Double-click `run_app.bat` (if Python is missing, the script will link you to the Windows installer).
